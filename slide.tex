...
\draw [->, very thick] (population) to[out=-90, in=60] node[auto=right] {$1\%$} (sick); 
\pause
\node[block,fill=gray!10] (not_sick) at (3.5,4) {not sick\\990人};
\draw [->,very thick] (population) to[out=-90, in=120]  node[auto=left] {$99\%$} (not_sick); 
\pause
\node[block,fill=red!10] (true_positive) at (-5,) {true positive\\9人};
\draw [->,very thick] (sick) to[out=-90, in=90]  node[auto=right] {$90\%$} (true_positive); 
\pause
\node[block,fill=gray!10] (false_negative) at (-2,1) {false negative\\1人};
\draw [->,very thick] (sick) to[out=-90, in=90]  node[auto=left] {$10\%$} (false_negative); 
\pause
\node[block,fill=gray!10] (true_negative) at (2,1) {true negative\\891人};
\draw [->,very thick] (not_sick) to[out=-90, in=90]  node[auto=right] {$90\%$} (true_negative); 
\pause
\node[block,fill=red!10] (false_positive) at (5,1) {false positive\\99人};
\draw [->,very thick] (not_sick) to[out=-90, in=90]  node[auto=left] {$10\%$} (false_positive); 
 \end{tikzpicture}%
}
\end{frame}
