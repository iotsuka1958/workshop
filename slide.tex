...
\begin{center}\Huge
\[
\frac{9}{9 + 99}=0.083333\ldots{}
\]
\end{center}
\end{frame}

\begin{frame}{answer}
\protect\hypertarget{answer-2}{}
\begin{itemize}[<+->]
\tightlist
\item
  有病率1\%, 感度90\%, 特異度90\%
...
\IfFileExists{./tebiki.jpg}{\scalebox{.9}{\rotatebox{-90}{\includegraphics[width=\textheight]{tebiki.jpg}}}}{\relax}
\end{frame}
...
\includegraphics[height=8cm]{slide_files/figure-beamer/unnamed-chunk-18-1}
\end{frame}
